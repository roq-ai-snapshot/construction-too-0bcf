  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Your One-Stop Destination for Easy and Convenient Access to a Wide Range of Construction Tools from Multiple Outlets."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606676539940-12768ce0e762?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjB0b29sc3xlbnwwfHx8fDE2OTEwNjA5MTV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Your One-Stop Destination for Easy and Convenient Access to a Wide Range of Construction Tools from Multiple Outlets.`}
            </Text>
            <Box
